...
class OpenApiDocumentationTest {
    ...
    fun openApiSpecDocumentsArticleEndpoints() {
        mockMvc.perform(get("/v3/api-docs"))
            ...
            .andExpect(jsonPath("$.paths['/api/articles'].get.description").value("Returns persisted curated articles. When query is provided, filters articles by title, summary, primary category, and topics while keeping the public response shape stable for a later Elasticsearch-backed search implementation."))
